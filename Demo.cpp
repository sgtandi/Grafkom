...
void Demo::BuildColoredCube() {
	...
	int width, height;
	unsigned char* image = SOIL_load_image("blue stone.png", &width, &height, 0, SOIL_LOAD_RGBA);
...
int main(int argc, char** argv) {
	...
	app.Start("Texture Mapping: Draw blue stone cube on top of wooden floor", 800, 600, false, false);
}